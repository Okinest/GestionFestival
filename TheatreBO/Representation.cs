...
namespace TheatreBO
{
    public class Representation
    {
        ...
        public Representation(int rep_id, DateTime rep_date, TimeSpan rep_time, Place rep_lieu, int rep_max_seats, Pieces piece, Rate rate)
        {
            this.rep_id = rep_id;
            this.rep_date = rep_date;
            this.rep_time = rep_time;
            this.rep_place = rep_lieu;
        ...
        public Representation(DateTime rep_date, TimeSpan rep_time, Place rep_lieu, int rep_max_seats, Pieces piece, Rate rate)
        {
            this.rep_date = rep_date;
            this.rep_time = rep_time;
            this.rep_place = rep_lieu;
        ...
        public Place Place { get { return rep_place; } set { rep_place = value; } }
        ...
        public string Place_name => rep_place != null ? Place.Name : string.Empty; // Expose le nom de la pièce
